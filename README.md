...
- Debian 13 or compatible (stable)
- Ubuntu 22.04/24.04/26.04 or compatible (stable)
- Kali (experimental)

Installation on older distributions (e.g. Debian 12 "Bookworm" or Ubuntu 20.04 "Focal") may still work, but is not
