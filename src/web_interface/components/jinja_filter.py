...
class FilterClass:
    ...
    def _filter_replace_uid_with_file_name(self, input_data: Any) -> str:  # noqa: ANN401
    ...
    def _filter_replace_uid_with_hid(self, input_data: Any, root_uid: str | None = None) -> str:  # noqa: ANN401
        tmp = str(input_data)
        if tmp == 'None':
            return ' '
        uid_list = flt.get_all_uids_in_string(tmp)
    ...
    def _filter_replace_comparison_uid_with_hid(self, input_data: Any, root_uid: str | None = None) -> str:  # noqa: ANN401
        tmp = self._filter_replace_uid_with_hid(input_data, root_uid)
        res = tmp.split(';')
        return '  ||  '.join(res)

    def _filter_replace_uid_with_hid_link(self, input_data: Any, root_uid: str | None = None) -> str:  # noqa: ANN401
    ...
    def check_auth(self, _) -> bool:  # noqa: ANN001
    ...
    def _get_chart_element_count(self) -> int:
