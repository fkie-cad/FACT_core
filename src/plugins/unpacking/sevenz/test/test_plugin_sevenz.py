...
class TestSevenZUnpacker(TestUnpackerBase):
    ...
    def test_unpacker_selection_generic(self):
        mimes = ['application/x-7z-compressed', 'application/x-lzma', 'application/x-executable', 'application/x-dosexec', 'application/zip', 'application/x-zip-compressed']
        for item in mimes:
