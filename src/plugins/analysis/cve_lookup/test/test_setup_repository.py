...
EXPECTED_CVE_OUTPUT = [
    ('CVE-2012-0001', 2012, 'cpe:2.3:o:microsoft:windows_7:-:*:*:*:*:*:*:*', '9.3', 'N/A', 'o', 'microsoft',
     'windows_7', 'N/A', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', ''),
    ('CVE-2012-0001', 2012, 'cpe:2.3:o:microsoft:windows_7:-:sp1:x64:*:*:*:*:*', '9.3', 'N/A', 'o', 'microsoft',
     'windows_7', 'N/A', 'sp1', 'x64', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', ''),
    ('CVE-2012-0001', 2012, 'cpe:2.3:o:microsoft:windows_7:-:sp1:x86:*:*:*:*:*', '9.3', 'N/A', 'o', 'microsoft',
     'windows_7', 'N/A', 'sp1', 'x86', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', ''),
    ('CVE-2012-0001', 2012, 'cpe:2.3:o:microsoft:windows_server_2003:*:sp2:*:*:*:*:*:*', '9.3', 'N/A', 'o',
     'microsoft', 'windows_server_2003', 'ANY', 'sp2', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '',
     '', ''),
    ('CVE-2012-0001', 2012, 'cpe:2.3:o:microsoft:windows_server_2008:*:sp2:x32:*:*:*:*:*', '9.3', 'N/A', 'o',
     'microsoft', 'windows_server_2008', 'ANY', 'sp2', 'x32', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '',
     '', ''),
    ('CVE-2012-0001', 2012, 'cpe:2.3:o:microsoft:windows_server_2008:*:sp2:x64:*:*:*:*:*', '9.3', 'N/A', 'o',
     'microsoft', 'windows_server_2008', 'ANY', 'sp2', 'x64', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '',
     '', ''),
    ('CVE-2012-0001', 2012, 'cpe:2.3:o:microsoft:windows_server_2008:-:sp2:itanium:*:*:*:*:*', '9.3', 'N/A', 'o',
     'microsoft', 'windows_server_2008', 'N/A', 'sp2', 'itanium', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '',
     '', ''),
    ('CVE-2012-0001', 2012, 'cpe:2.3:o:microsoft:windows_server_2008:r2:*:itanium:*:*:*:*:*', '9.3', 'N/A', 'o',
     'microsoft', 'windows_server_2008', 'r2', 'ANY', 'itanium', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '',
     '', ''),
    ('CVE-2012-0001', 2012, 'cpe:2.3:o:microsoft:windows_server_2008:r2:*:x64:*:*:*:*:*', '9.3', 'N/A', 'o',
     'microsoft', 'windows_server_2008', 'r2', 'ANY', 'x64', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '',
     '', ''),
    ('CVE-2012-0001', 2012, 'cpe:2.3:o:microsoft:windows_server_2008:r2:sp1:itanium:*:*:*:*:*', '9.3', 'N/A', 'o',
     'microsoft', 'windows_server_2008', 'r2', 'sp1', 'itanium', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '',
     '', ''),
    ('CVE-2012-0001', 2012, 'cpe:2.3:o:microsoft:windows_server_2008:r2:sp1:x64:*:*:*:*:*', '9.3', 'N/A', 'o',
     'microsoft', 'windows_server_2008', 'r2', 'sp1', 'x64', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '',
     '', ''),
    ('CVE-2012-0001', 2012, 'cpe:2.3:o:microsoft:windows_vista:*:sp2:*:*:*:*:*:*', '9.3', 'N/A', 'o', 'microsoft',
     'windows_vista', 'ANY', 'sp2', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', ''),
    ('CVE-2012-0001', 2012, 'cpe:2.3:o:microsoft:windows_vista:*:sp2:x64:*:*:*:*:*', '9.3', 'N/A', 'o',
     'microsoft', 'windows_vista', 'ANY', 'sp2', 'x64', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', ''),
    ('CVE-2012-0001', 2012, 'cpe:2.3:o:microsoft:windows_xp:*:sp2:professional_x64:*:*:*:*:*', '9.3', 'N/A', 'o',
     'microsoft', 'windows_xp', 'ANY', 'sp2', 'professional_x64', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '',
     '', ''),
    ('CVE-2018-0010', 2018, 'cpe:2.3:a:microsoft:ie:6:*:*:*:*:*:*:*', '4.3', 'N/A', 'a', 'microsoft', 'ie', '6',
     'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', ''),
    ('CVE-2018-0010', 2018, 'cpe:2.3:a:microsoft:ie:7:*:*:*:*:*:*:*', '4.3', 'N/A', 'a', 'microsoft', 'ie', '7',
     'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', ''),
    ('CVE-2018-0010', 2018, 'cpe:2.3:a:microsoft:ie:8:*:*:*:*:*:*:*', '4.3', 'N/A', 'a', 'microsoft', 'ie', '8',
     'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', ''),
    ('CVE-2018-0010', 2018, 'cpe:2.3:a:microsoft:ie:9:*:*:*:*:*:*:*', '4.3', 'N/A', 'a', 'microsoft', 'ie', '9',
     'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', '')
]
...
EXPECTED_SUM_OUTPUT = [
    ('CVE-2018-20229', 2018, 'GitLab Community and Enterprise Edition before 11.3.14, 11.4.x before 11.4.12, and 11.5.x before 11.5.5 allows Directory Traversal.', 'N/A', 'N/A'),
    ('CVE-2018-8825', 2018, 'Google TensorFlow 1.7 and below is affected by: Buffer Overflow. The impact is: execute arbitrary code (local).', 'N/A', 'N/A')
]

EXPECTED_UPDATED_CPE_TABLE = [
    ('cpe:2.3:a:\\$0.99_kindle_books_project:\\$0.99_kindle_books:6:*:*:*:*:android:*:*', 'a',
     '\\$0\\.99_kindle_books_project', '\\$0\\.99_kindle_books', '6', 'ANY', 'ANY', 'ANY', 'ANY', 'android', 'ANY',
     'ANY'),
    ...
    ('cpe:2.3:a:1024cms:1024_cms:1.3.1:*:*:*:*:*:*:*', 'a', '1024cms', '1024_cms', '1\\.3\\.1', 'ANY', 'ANY', 'ANY',
     'ANY', 'ANY', 'ANY', 'ANY'),
    ('cpe:2.3:a:1024cms:1024_cms:1.4.1:*:*:*:*:*:*:*', 'a', '1024cms', '1024_cms', '1\\.4\\.1', 'ANY', 'ANY', 'ANY',
     'ANY', 'ANY', 'ANY', 'ANY')
]

EXPECTED_UPDATED_CVE_TABLE = [
    ('CVE-2018-0010', 2018, 'cpe:2.3:a:microsoft:ie:6:*:*:*:*:*:*:*', '4.3', 'N/A', 'a', 'microsoft', 'ie',
     '6', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', ''),
    ('CVE-2018-0010', 2018, 'cpe:2.3:a:microsoft:ie:7:*:*:*:*:*:*:*', '4.3', 'N/A', 'a', 'microsoft', 'ie',
     '7', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', ''),
    ('CVE-2018-0010', 2018, 'cpe:2.3:a:microsoft:ie:8:*:*:*:*:*:*:*', '4.3', 'N/A', 'a', 'microsoft', 'ie',
     '8', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', ''),
    ('CVE-2018-0010', 2018, 'cpe:2.3:a:microsoft:ie:9:*:*:*:*:*:*:*', '4.3', 'N/A', 'a', 'microsoft', 'ie',
     '9', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', ''),
    ('CVE-2018-1136', 2018, 'cpe:2.3:a:moodle:moodle:*:*:*:*:*:*:*:*', '4', '4.3', 'a', 'moodle', 'moodle',
     'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '3.1.0', '', '3.1.11', ''),
    ('CVE-2018-1136', 2018, 'cpe:2.3:a:moodle:moodle:*:*:*:*:*:*:*:*', '4', '4.3', 'a', 'moodle', 'moodle',
     'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '3.2.0', '', '3.2.8', ''),
    ('CVE-2018-1136', 2018, 'cpe:2.3:a:moodle:moodle:*:*:*:*:*:*:*:*', '4', '4.3', 'a', 'moodle', 'moodle',
     'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '3.3.0', '', '3.3.5', ''),
    ('CVE-2018-1136', 2018, 'cpe:2.3:a:moodle:moodle:*:*:*:*:*:*:*:*', '4', '4.3', 'a', 'moodle', 'moodle',
     'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '3.4.0', '', '3.4.2', ''),
    ('CVE-2018-20229', 2018, 'cpe:2.3:o:microsoft:windows_xp:*:sp3:*:*:*:*:*:*', 'N/A', 'N/A', 'o', 'microsoft',
     'windows_xp', 'ANY', 'sp3', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', ''),
    ('CVE-2018-20229', 2018, 'cpe:2.3:o:microsoft:windows_xp:-:sp2:x64:*:*:*:*:*', 'N/A', 'N/A', 'o',
     'microsoft', 'windows_xp', 'N/A', 'sp2', 'x64', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', '')
]
EXPECTED_UPDATED_SUMMARY_TABLE = [
    ('CVE-2012-0001', 2012,
     ...
     'application, aka \"Windows Kernel SafeSEH Bypass Vulnerability.\"', '9.3', 'N/A'),
    ('CVE-2018-7576', 2018,
...
def test_init_cve_feeds_table():
    ...
    expected = [
        ...
        ('CVE-2012-0001', 2012, 'cpe:2.3:a:1024cms:1024_cms:1.2.5:*:*:*:*:*:*:*', 'N/A', 'N/A', 'a', '1024cms',
         '1024_cms', '1\\.2\\.5', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', 'ANY', '', '', '', ''),
        ('CVE-2012-0001', 2012, 'cpe:2.3:a:\\$0.99_kindle_bo\\:oks_project:\\$0.99_kindle_books:6:*:*:*:*:android:*:*',
         'N/A', 'N/A', 'a', '\\$0\\.99_kindle_bo\\:oks_project', '\\$0\\.99_kindle_books', '6', 'ANY', 'ANY',
