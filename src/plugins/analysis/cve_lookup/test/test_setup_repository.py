...
def test_extract_relevant_feeds():
    ...
    assert [('CVE-2018-0002', 2018),
            ('CVE-2018-0003', 2018)] == sorted(sr.extract_relevant_feeds(from_table='new', where_table='outdated'))
...
def test_setup_cve_summary_table():
    summary_input = [
        ...
        CveSummaryEntry('CVE-2018-0010', 'foobar', {
            'cvssV2': '7.3', 'cvssV3': '8.3'
        }),
    ]
    expected_output = [
