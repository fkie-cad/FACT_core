...
class AnalysisPlugin(AnalysisBasePlugin):
    ...
    def probably_kernel_config(self, raw_data):
        try:
    ...
    def try_object_extract_ikconfig(raw_data):
        ...
        maybe_configs = decomp.decompress(container[start_offset:])
    ...
    @staticmethod
    def object_mime_is_plaintext(file_object):
    ...
    @staticmethod
    def object_is_kernel_image(file_object):
        return 'software_components' in file_object.processed_analysis and \
               ...
               'Linux Kernel' in file_object.processed_analysis['software_components']['summary']
