...
class TestStringEval(unittest.TestCase):
    ...
    def test_add_mail_adress_score(self):
        ...
        assert result_true > 0 == True, 'Mail false-negative'
        assert result_false > 0 == False, 'Mail false-positive'
    ...
    def test_add_parameter_score(self):
        ...
        assert result_true > 0 == True, 'Parameter not detected'
        assert result_true2 > 0 == True, 'Parameter not detected'
        assert result_false > 0 == False, 'Parameter wrongly detected'
    ...
    def test_add_html_score(self):
        ...
        assert result_true > 0 == True, 'html not detected'
        assert result_true2 > 0 == True, 'html not detected'
        assert result_false > 0 == False, 'html wrongly detected'
    ...
    def test_add_case_ratio_score(self):
        ...
        assert result_true > 0 == True, 'case ratio wrongly detected'
        assert result_false < 0 == True, 'case ratio wrongly detected'
    ...
    def test_add_dictionary_score(self):
        ...
        assert result_true > 0 == True, 'dict word not detected'
        assert result_true2 > 0 == True, 'dict word not detected'
        assert result_false > 0 == False, 'dict word wrongly detected'
    ...
    def test_add_format_string_score(self):
        ...
        assert result_true < 0 == True, 'Parameter not detected'
        assert result_true2 < 0 == True, 'Parameter not detected'
        assert result_false == 0 == True, 'Parameter wrongly detected'
    ...
    def test_add_path_score(self):
        ...
        assert result_true > 0 == True, 'Path not detected'
        assert result_false > 0 == False, 'Path wrongly detected'
    ...
    def test_add_possible_version_number_score(self):
        ...
        assert result_true > 0 == True, 'version not detected'
        assert result_false > 0 == False, 'version wrongly detected'
    ...
    def test_add_possible_year_score(self):
        ...
        assert result_true > 0 == True, 'year not detected'
        assert result_false > 0 == False, 'year wrongly detected'
    ...
    def test_add_quad_characters_score(self):
        ...
        assert result_true < 0 == True, 'qcharacter not detected'
        assert result_false > 0 == False, 'qcharacter wrongly detected'
    ...
    def test_add_rare_special_character_score(self):
        ...
        assert result_true < 0 == True, 'rare character not detected'
        assert result_false > 0 == False, 'rare character wrongly detected'
    ...
    def test_add_special_character_ratio_score(self):
        ...
        assert result_true < 0 == True, 'special normal ratio fail'
        assert result_false > 0 == True, 'special to normal ratio fail2'
    ...
    def test_add_underscore_or_period_at_beginning_score(self):
        ...
        assert result_true < 0 == True, 'underscore or period not detected'
        assert result_true2 < 0 == True, 'underscore or period not detected'
        assert result_true3 < 0 == True, 'underscore or period not detected'

    def test_score(self):
        input_data = 'score me pls'
        result = _score(input_data)
        assert result[1] > 0 == True, 'score should be above 0!'
