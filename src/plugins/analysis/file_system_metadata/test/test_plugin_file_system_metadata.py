...
class TestFileSystemMetadata:
    ...
    def test_extract_metadata__correct_method_is_called(self, file_system_metadata_plugin, monkeypatch):
        ...
        monkeypatch.setattr(file_system_metadata_plugin, '_extract_metadata_from_tar', _extract_metadata_from_archive_mock)
        ...
        monkeypatch.setattr(file_system_metadata_plugin, '_extract_metadata_from_file_system', _extract_metadata_from_file_system_mock)
