...
def load_information(file_path):
    ...
    if not(shell_skript.exists()):
        #execute_shell_command(['chmod', '+x' ,str(install_shell_skript)])
...
def check_mitigations(file_path):
    ...
    #check_selfrando(file_path, dict_res, dict_sum, dict_file_info)
    ...
    check_stripped_symbols_in_the_binary(file_path, dict_res, dict_sum, dict_file_info)
...
def check_stripped_symbols_in_the_binary(file_path, dict_res, dict_sum, dict_file_info):
