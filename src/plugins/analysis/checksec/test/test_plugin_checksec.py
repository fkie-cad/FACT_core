...
@pytest.mark.parametrize(
    ...
    [
        (FILE_PATH_EXE, check_pie, {
            'PIE': 'enabled'
        }, 'PIE enabled'),
        (FILE_PATH_OBJECT, check_pie, {
            'PIE': 'REL'
        }, 'PIE/REL present'),
        (FILE_PATH_SHAREDLIB, check_pie, {
            'PIE': 'DSO'
        }, 'PIE/DSO present'),
        (FILE_PATH_EXE_NO_PIE, check_pie, {
            'PIE': 'disabled'
        }, 'PIE disabled'),
        # TODO: Test PIE: invalid ELF-File
        (FILE_PATH_EXE, check_relro, {
            'RELRO': 'fully enabled'
        }, 'RELRO fully enabled'),
        (FILE_PATH_OBJECT, check_relro, {
            'RELRO': 'disabled'
        }, 'RELRO disabled'),
        (FILE_PATH_SHAREDLIB, check_relro, {
            'RELRO': 'partially enabled'
        }, 'RELRO partially enabled'),
        (FILE_PATH_EXE, check_nx, {
            'NX': 'enabled'
        }, 'NX enabled'),
        (FILE_PATH_OBJECT, check_nx, {
            'NX': 'disabled'
        }, 'NX disabled'),
        (FILE_PATH_EXE, check_canary, {
            'CANARY': 'disabled'
        }, 'CANARY disabled'),
        (FILE_PATH_EXE_CANARY, check_canary, {
            'CANARY': 'enabled'
        }, 'CANARY enabled'),
        (FILE_PATH_EXE, check_fortify_source, {
            'FORTIFY_SOURCE': 'disabled'
        }, 'FORTIFY_SOURCE disabled'),
        (FILE_PATH_EXE_FORTIFY, check_fortify_source, {
            'FORTIFY_SOURCE': 'enabled'
        }, 'FORTIFY_SOURCE enabled'),
        (FILE_PATH_EXE, check_clang_cfi, {
            'CLANGCFI': 'disabled'
        }, 'CLANGCFI disabled'),
        # TODO: Test CLANCFI: enabled
        (FILE_PATH_EXE, check_clang_safestack, {
            'SAFESTACK': 'disabled'
        }, 'SAFESTACK disabled'),
        (FILE_PATH_EXE_SAFESTACK, check_clang_safestack, {
            'SAFESTACK': 'enabled'
        }, 'SAFESTACK enabled'),
        (FILE_PATH_EXE, check_rpath, {
            'RPATH': 'disabled'
        }, 'RPATH disabled'),
        (FILE_PATH_EXE_RPATH, check_rpath, {
            'RPATH': 'enabled'
        }, 'RPATH enabled'),
        (FILE_PATH_EXE, check_runpath, {
            'RUNPATH': 'disabled'
        }, 'RUNPATH disabled'),
        (FILE_PATH_EXE_RUNPATH, check_runpath, {
            'RUNPATH': 'enabled'
        }, 'RUNPATH enabled'),
        (FILE_PATH_EXE, check_stripped_symbols, {
