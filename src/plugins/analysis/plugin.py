...
@dataclass
class Tag:
    """A dataclass for tags that is more convinient than dictionaries.
    The strucutre of the dict is defined in the docs for :py:attr:`objects.FileObject.analysis_tags`.
    """
...
class PluginV0(metaclass=abc.ABCMeta):
    ...
    # FIXME(python3.7 eol): Uncomment this
    # @typing.final
