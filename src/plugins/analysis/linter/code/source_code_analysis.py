    ...
    def process_object(self, file_object):
        ...
        if script_type is None:
            file_object.processed_analysis[self.NAME] = {
                'summary': [], 'warning': 'Is not a script or language could not be detected'
            }
            return file_object
        ...
        if script_type not in self.linter_impls:
            ...
            file_object.processed_analysis[self.NAME] = {
                'summary': [], 'warning': f'Unsupported script type: {script_type}'
            }
            return file_object
        ...
        if len(issues) == 0:
            ...
            file_object.processed_analysis[self.NAME] = {
                'full': sorted(issues, key=lambda k: k['symbol']), 'summary': [f'Warnings in {script_type} script']
            }
        return file_object
