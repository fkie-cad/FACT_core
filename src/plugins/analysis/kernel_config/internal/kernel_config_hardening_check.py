...
PROTECTS_AGAINST = {
    ...
    ['Stack Depth Overflow (CWE-674)', 'Uninitialized Memory Usage (CWE-908)', 'Info Exposure (CWE-200)'],
    ...
    ['Use-After-Free (CWE-416)', 'Uninitialized Memory Usage (CWE-908)', 'Info Exposure (CWE-200)'],
    ...
    ['ret2usr', 'ret2usr + ROP', 'Userspace Data Access', 'NULL Pointer Dereference (CWE-476)'],
