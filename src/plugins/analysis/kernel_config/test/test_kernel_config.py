...
class KernelConfigTest(AnalysisPluginTest):
    ...
    def test_process_configs_ko_success(self):
        ...
        assert test_file.processed_analysis[self.PLUGIN_NAME]['result']['is_kernel_config']
        assert len(test_file.processed_analysis[self.PLUGIN_NAME]['result']['kernel_config']) > 0
    ...
    def test_process_configs_ko_failure(self):
        ...
        assert 'is_kernel_config' not in test_file.processed_analysis[self.PLUGIN_NAME]['result']
        assert 'kernel_config' not in test_file.processed_analysis[self.PLUGIN_NAME]['result']
    ...
    def test_process_valid_plain_text(self):
        ...
        assert test_file.processed_analysis[self.PLUGIN_NAME]['result']['is_kernel_config']
        assert test_file.processed_analysis[self.PLUGIN_NAME]['result']['kernel_config'] == test_file.binary.decode()
...
def test_has_kconfig_type(full_type, expected_output):
