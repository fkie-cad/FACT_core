...
class TestRestFirmware(RestTestBase):
    ...
    def test_offset_to_empty_response(self, db):
        test_firmware = create_test_firmware(device_class='test class', device_name='test device', vendor='test vendor')
        db.backend.add_object(test_firmware)
    ...
    def test_stable_response_on_bad_paging(self, db):
    ...
    def test_rest_search_existing(self, db):
        test_firmware = create_test_firmware(device_class='test class', device_name='test device', vendor='test vendor')
        db.backend.add_object(test_firmware)
    ...
    def test_rest_search_not_existing(self, db):
        test_firmware = create_test_firmware(device_class='test class', device_name='test device', vendor='test vendor')
        db.backend.add_object(test_firmware)
    ...
    def test_rest_upload_valid(self, db):
        data = {
    ...
    def test_rest_upload_invalid(self, db):
        data = {
            'binary': standard_b64encode(b'test_file_content').decode(),
            'file_name': 'test_file.txt',
            'device_name': 'test_device',
    ...
    def test_rest_update_analysis_success(self, db):
        test_firmware = create_test_firmware(device_class='test class', device_name='test device', vendor='test vendor')
        db.backend.add_object(test_firmware)
    ...
    def test_rest_update_bad_query(self, db):
        test_firmware = create_test_firmware(device_class='test class', device_name='test device', vendor='test vendor')
        db.backend.add_object(test_firmware)
    ...
    def test_rest_download_with_summary(self, db):
        test_firmware = create_test_firmware(device_class='test class', device_name='test device', vendor='test vendor')
        db.backend.add_object(test_firmware)

        request_with_summary = self.test_client.get(
            f'/rest/firmware/{test_firmware.uid}?summary=true',
