...
class TestRestStartCompare(RestTestBase):
    ...
    def test_rest_start_compare_invalid_uid(self, db):
    ...
    def test_rest_start_compare_invalid_data(self, db):
