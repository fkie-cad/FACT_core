...
class TestAppUpload(WebInterfaceTest):
    ...
    def test_edit_roles(self, caplog):
        ...
        with caplog.at_level(logging.INFO):
            self.test_client.post('/admin/user/0', follow_redirects=True, data={'input_roles': [roles[0], roles[2]]})
    ...
    def test_edit_roles__unknown_element(self):
        response = self.test_client.post('/admin/user/9999', follow_redirects=True, data={'input_roles': [roles[0]]})
