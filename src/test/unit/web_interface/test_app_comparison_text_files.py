...
from test.common_helper import TEST_TEXT_FILE, TEST_TEXT_FILE2, CommonDatabaseMock, create_test_firmware
from test.unit.conftest import CommonIntercomMock, WebInterfaceUnitTestConfig
