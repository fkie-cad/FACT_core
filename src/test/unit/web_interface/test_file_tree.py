...
NON_VIRTUAL_TREE_ROOT = {
    'a_attr': {
        'href': '/analysis/someUID/ro/someUID'
    },
    'children': True,
    'data': {
        'uid': 'someUID'
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('application/x-executable', '/static/file_icons/binary.png'), ('inode/symlink', '/static/file_icons/link.png'),
        ('text/html', '/static/file_icons/html.png'), ('firmware/generic', '/static/file_icons/firmware.png'),
...
class TestVirtualPathFileTree:
    ...
    def test_multiple_occurrences(self):
        fo_data = {
            **self.tree_data,
            'virtual_file_path': {
                'root_uid': ['root_uid|parent_uid|/foo/bar', 'root_uid|other_uid|/other/path']
            }
        }
