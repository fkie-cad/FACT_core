...
from helperFunctions.virtual_file_path import (
    get_base_of_virtual_path,
    get_parent_uids_from_virtual_path,
    get_top_of_virtual_path,
    join_virtual_path,
    merge_vfp_lists,
    split_virtual_path,
    update_virtual_file_path,
)
...
@pytest.mark.parametrize(
    'old_vfp_list, new_vfp_list, expected_output',
    [
        ([], [], []),
...
@pytest.mark.parametrize(
    'old_vfp, new_vfp, expected_result',
    [
        ({}, {}, {}),
        ({
            'uid1': ['p1', 'p2']
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({
            'some_UID': ['|uid1|uid2|/folder_1/some_file']
        }, {'uid2'}),
        ({
            'some_UID': ['|uid1|uid2|/folder_1/some_file', '|uid1|uid2|/folder_2/some_file']
        }, {'uid2'}),
        ({
            'uid1': ['|uid1|uid2|/folder_1/some_file', '|uid1|uid3|/some_file']
        }, {'uid2', 'uid3'}),
        ({
            'uid1': ['|uid1|uid2|/folder_1/some_file'], 'other_UID': ['|other_UID|uid2|/folder_2/some_file']
        }, {'uid2'}),
        ({
            'uid1': ['|uid1|uid2|/folder_1/some_file'], 'other_UID': ['|other_UID|uid3|/some_file']
        }, {'uid2', 'uid3'}),
    ],
)
