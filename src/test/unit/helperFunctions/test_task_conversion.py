...
class TestTaskConversion:
    ...
    def test_get_uploaded_file_binary_error(self):
        assert _get_uploaded_file_binary(None, None) is None, 'missing upload file should lead to None'

    def test_get_uid_of_analysis_task(self):
        analysis_task = {'binary': b'this is a test'}
        assert _get_uid_of_analysis_task(analysis_task) == '2e99758548972a8e8822ad47fa1017ff72f06f3ff6a016851f45c398732bc50c_14', 'result is not a uid'
    ...
    def test_convert_analysis_task_to_firmware_object(self):
        ...
        assert fw_obj.uid == '2e99758548972a8e8822ad47fa1017ff72f06f3ff6a016851f45c398732bc50c_14', 'uid not correct -> binary not correct'
