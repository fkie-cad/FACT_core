...
def _show_analysis_page(test_client, test_fw_a):
...
def _check_ajax_file_tree_routes(test_client, test_fw_a):
...
def _show_analysis_details_file_type(test_client, test_fw_a):
...
def _delete_firmware(test_client, test_fw_a):
...
def test_run_from_upload_via_show_analysis_to_delete(test_client, analysis_finished_event,  test_fw_a):
    ...
    _show_home_page(test_client, test_fw_a)
    _re_do_analysis_get(test_client, test_fw_a)
    _delete_firmware(test_client, test_fw_a)
