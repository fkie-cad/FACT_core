...
class TestAcceptanceAnalyzeFirmware:
    ...
    def _show_analysis_page(self, test_client):
    ...
    def _check_ajax_file_tree_routes(self, test_client):
    ...
    def _show_analysis_details_file_type(self, test_client):
    ...
    def _re_do_analysis_get(self, test_client):
    ...
    def _delete_firmware(self, test_client):
    ...
    def test_run_from_upload_via_show_analysis_to_delete(self, test_client, analysis_finished_event):
        ...
        self._show_analysis_page(test_client)
        self._show_analysis_details_file_type(test_client)
        self._check_ajax_file_tree_routes(test_client)
        self._check_ajax_on_demand_binary_load(test_client)
        self._show_home_page(test_client)
        self._re_do_analysis_get(test_client)
        self._delete_firmware(test_client)
