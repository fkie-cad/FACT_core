...
class AnalysisStatus:
    ...
    def add_update(self, fw_object: Firmware | FileObject, included_files: list[str] | set[str]) -> None:
        self.add_object(fw_object)
        self._worker.queue.put((_UpdateType.add_update, fw_object.uid, included_files))

    def add_object(self, fw_object: Firmware | FileObject) -> None:
    ...
    def remove_object(self, fw_object: Firmware | FileObject) -> None:
...
class AnalysisStatusWorker:
    ...
    def _add_firmware(self, uid: str, included_files: set[str], hid: str, scheduled_analyses: list[str] | None) -> None:
    ...
    def _get_current_analyses_stats(self) -> dict:
        return {
            uid: {
