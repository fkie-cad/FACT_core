...
from fact.plugins.analysis.known_vulnerabilities.internal.rulebook import BadRuleError, SingleRule, Vulnerability
...
def test_dummy_vulnerability():
    vulnerability = Vulnerability(
        description='', score='high', reliability='50', short_name='dummy bug', rule=DUMMY_RULE, link='http://dummy.gov'
    )
