...
def install_statistic_cronjob():
    ...
    statistic_update_script_path = os.path.join(get_directory_of_current_file(), 'src/update_statistic.py')
    variety_update_script_path = os.path.join(get_directory_of_current_file(), 'src/update_variety_data.py')
